...
public class MainController {
    ...
    public String index(Model model){
        ...
        //System.out.println("S-a apelat index!");
    ...
    {
        MongoCollection<Document> directIndex = ProjectRIWApplication.directIndexForSearch;
        MongoCollection<Document> inverseIndex = ProjectRIWApplication.inverseIndexForSearch;
        ...
        /*creez un document corespunzator query-ului--------------------*/
        ...
        if(documents.size() > 0){
            //sort descending by distance value
            ...
            for(Document doc : documents){
                ...
                //Double module = doc.getDouble("module");
                ...
                //System.out.println("Doc: " + docName+ ", dist=" + distToQuery);
            }
